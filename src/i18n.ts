  ...
  .init({
    ...
    resources: {
      ...
      es: {
        translation: {
          heading: {
            title: "Analiza tu proyecto de Ableton Live",
            subTitle:
          ...
          faq: {
            title: "Uso del ALS Analysis",
            subTitle1:
              "Esta herramienta muestra información de tus proyectos de Ableton Live sin tener que cargarlos en tu DAW.",
            subTitle2:
              "Identifica las dependencias de plugins y archivos de audio en tus proyectos.",
            question1: {
              question: "¿Cómo se realiza el análisis?",
              answer:
                "Cada archivo seleccionado se procesa utilizando JavaScript ejecutado del lado del cliente para recopilar información sin necesitar cargar los datos de tu proyecto a sistemas externos.",
            },
            question2: {
              question: "¿Dónde se almacena la información de mi análisis?",
              answer:
                "La información se guarda en el almacenamiento local del navegador, asegurando así que no se envíe a ninguna base de datos o sistema externo.",
            },
            question3: {
              question:
            ...
            question4: {
              ...
              answer:
                "Podrás ver: <ul className='flex list-disc flex-col gap-3 px-6'> <li> Una lista de cada tipo de pista (Audio, MIDI, Grupo, Envío, Master) con un resumen de los dispositivos y audios en ella. <div className='text-xs italic text-muted-foreground/70'> Consejo: pasa el mouse sobre el contador de Dispositivos y Audios para obtener detalles. </div> </li> <li> Un resumen de todos los dispositivos <b className='text-destructive'>Externos</b> (VST, VST3 o M4L) utilizados. </li> <li> Un resumen de todos los Clips de Audio, marcando cualquier Clip <b className='text-destructive'>Externo</b>. <div className='text-xs italic text-muted-foreground/70'> Consejo: pasa el mouse sobre la ruta del Clip de Audio para obtener el directorio completo. </div> </li> </ul>",
            },
            contribute: {
